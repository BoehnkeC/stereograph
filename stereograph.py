...
/***************************************************************************
 Stereograph
                                 A QGIS plugin
 This plugin plots structural geology data
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2019-07-19
        git sha              : $Format:%H$
        copyright            : (C) 2019 by Christian Böhnke
...
from .stereograph_main import StereographDockWidget
import os.path
...
class Stereograph:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/stereograph/icon.png'
        self.add_action(
            icon_path,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = StereographDockWidget()
